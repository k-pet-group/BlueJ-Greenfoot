...
public class BoundedEnv extends SquareEnvironment
{
  ...
  // modifier methods
     ...
     * <p>
     * 
     * Populates the world with randomly-colored darter fish in random locations.
     */
    public void populateDarter()
    {
        Fish fish;
        Color color;
        Location loc;
        ...
        for (int i = 1; i < rows; i++) {
           ...
           if ( isEmpty(loc) ) {
              fish = new DarterFish(this, loc , randomDirection(), color); 
              addObject(fish, c, r);
           }
        }
    } 
     ...
     * <p>
     * 
     * Populates the world with normal and slow fish, randomly-colored,
     * in random locations.
     */
    public void populateSlowAndNormal()
    {
        Fish fish;
        Color color;
        Location loc;
        ...
        {  
           ...
           loc =  new Location(r,c);
           if ( isEmpty(loc) ) {
              fish = new SlowFish(this, loc , randomDirection(), color); 
              addObject(fish, c, r);
           }
     ...
     * <p>
     * 
     * Populates the world with normal and darter fish, randomly-colored,
     * in random locations.
     */
    public void populateDarterAndNormal()
    {
        Fish fish;
        Color color;
        Location loc;
     ...
     * <p>
     * 
     * Populates the world with normal, slow, and darter fish, randomly-colored,
     * in random locations.
     */
    public void populate3Species()
    {
        Fish fish;
        Color color;
        Location loc;
