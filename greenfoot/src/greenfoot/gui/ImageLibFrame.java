...
public class ImageLibFrame extends EscapeDialog implements ListSelectionListener, WindowListener
{
    ...
    /** The button used for editing images. */
    private EditButton editButton;
    /** The button used for deleting images. */
    ...
    private void buildUI(GProject project, boolean includeClassNameField)
    {
        ...
        // Browse and edit panel. Select image file from arbitrary location.
        {
            ...
            deleteButton = new JButton(Config.getString("imagelib.delete.button"));
            deleteButton.setEnabled(false);
            deleteButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e)
                {
                    int result = JOptionPane.showConfirmDialog(flowPanel, "Really delete " + selectedImageFile.getName() + "?", "Caution", JOptionPane.YES_NO_OPTION);
            ...
            editButton = new EditButton(Config.getString("imagelib.edit.button"));
            ...
            editButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e)
                {
                    ...
                    if(new File(imageEditor).exists() /*&& new File(imageEditor).canExecute()*/) {
                        ...
                        try {
                            editorProcess = Runtime.getRuntime().exec(command);
                        } catch (IOException ex) {
                            ex.printStackTrace();
                        }

                        Component frame = SwingUtilities.getRoot((Component)e.getSource());
                        ...
                        String message = "Either the image editing program you have specified doesn't exist, or you don't have the permissions to execute it.";
                        JOptionPane.showMessageDialog(flowPanel, message, "Couldn't edit image.", JOptionPane.ERROR_MESSAGE);
                    }
                }
            });
