 ...
 * @version $Id: ClassForest.java 3854 2006-03-21 20:23:38Z mik $
 */
public class ClassForest
{
    ...
    private Map treeEntryMap = new Hashtable();
    ...
    /**
     * Add a new class to this forest.
     */
    ...
    {
        boolean found = classesList.remove(cls);
        if(found)
            buildForest();
        return found;
    }
