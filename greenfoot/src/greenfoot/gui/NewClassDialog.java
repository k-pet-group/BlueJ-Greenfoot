...
/**
 * Dialog that ask for the name of a new class
 * 
...
public class NewClassDialog extends JDialog
{
    ...
    {
        super(parent, "Create subclass of " + className, true);
        ...
        this
                .setLocation((parent.getSize().width - getSize().width) / 2,
                        (parent.getSize().width - getSize().width) / 2);
