/*
 ...
 Copyright (C) 2019,2020,2022,2023,2026  Michael Kolling and John Rosenberg
...
public class TestBasicEditorInteraction extends FXTest
{
    ...
    public void start(Stage stage) throws Exception
    {
        ...
        this.stage = stage;
        flowEditor = new FlowEditor(null, "", null, null, null, () -> {}, new ReadOnlyBooleanWrapper(true), true, new JavaLanguageSupport());
            ...
            switch (action)
            {
                ...
                case 4:
                    ...
                    for (int c = 0; c < cutCount; c++)
                    {
                        ...
                        // and we haven't cut anything else then we won't see anything being changed on the clipboard
