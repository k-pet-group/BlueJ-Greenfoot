...
/**
 ** JavacCompiler class - an interface to Sun's javac compiler
...
public class BlueJJavacMain extends sun.tools.javac.Main
{
	...
	File destDir = null;
	int flags = F_WARNINGS | F_INNERCLASSES | F_PRINT_DEPENDENCIES;
	...
	for (int i = 0; i < argv.length; i++) {
		...
		if ((i + 1) < argv.length)
		    ...
		    error("-encoding requires argument");
		    usage();
		    return false;
		}
	    }
