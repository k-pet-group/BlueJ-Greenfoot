...
public class MoePlainView extends View implements TabExpander
{
    ...
    public int viewToModel(float x, float y, Shape a, Bias[] biasReturn)
    {
        ...
        // Element line = getDocument().getDefaultRootElement().getElement(lindex);
    ...
    public void paint(Graphics g, Shape allocation)
    {
        ...
        for (int i = topLine; i <= bottomLine; i++) {
            ...
            if (lh != null) {
                // The adjust prevents the highlight from painting the entire line; instead it will
                // just paint from the selection start, up to the selection end.
                int adjust = (i == maxLine) ? 0 : 1;
                lh.paintLayeredHighlights(g, line.getStartOffset(), line.getEndOffset() - adjust, allocation, host, this);
            }
