...
/**
 ** @version $Id: PkgMgrFrame.java 36 1999-04-27 04:04:54Z mik $
 ** @author Michael Cahill
 **
 ** Frame to edit a single file.
 **/
public abstract class PkgMgrFrame extends BlueJFrame implements ActionListener, ItemListener { 
    ...
    public void doClose()
    {
	doSave();   // always automatically save - don't ask
	super.doClose();
    }
     ...
     * recognises BlueJ packages and treats them differently: on
     * selection of a JB package directory it will return rather
     * than open that directory).
     */
    ...
    public String openPackageDialog(boolean onlyJBPackages)
    {
	String pkgname = null;
	JFileChooser chooser;

	if(onlyJBPackages)
	    chooser = getPackageChooser();
	else
	    chooser = getFileChooser(true);
