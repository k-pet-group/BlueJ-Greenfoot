/*
 ...
 Copyright (C) 1999-2013,2016,2017,2018,2019  Michael Kolling and John Rosenberg
...
public class AboutDialogTemplate extends Dialog<Void>
{
    ...
    private Tab createMainTab(String version, String websiteURL, Image image)
    {
        ...
        String teamText = String.join(", ", "Neil Brown", 
                "Michael Kölling", "Pierre Weill-Tessier" + ".");
