 ...
 */
public abstract class FXPkgMgrAction extends FXAbstractAction
{
    // --------- CLASS VARIABLES ----------
    ...
    public FXPkgMgrAction(PkgMgrFrame pmf, String s)
    {
    	this(pmf, s, false);
    }

    public FXPkgMgrAction(PkgMgrFrame pmf, String s, boolean showsDialog)
    {
     ...
     *                          KeyEvent.*)
     */
    public FXPkgMgrAction(PkgMgrFrame pmf, String s, KeyCode keycode)
    {
     ...
     */
    public FXPkgMgrAction(PkgMgrFrame pmf, String s, KeyCode keycode, Modifier modifiers)
    {
