 ...
 * @version 1.0
 */
public class GUIMenuCheckboxItem extends CheckboxMenuItem implements GUIMenuLeafComponent
{
    ...
    /**
     * Constructs a new GUIMenuCheckboxItem with no label.
     *
     * @param structCont    The StructureContainer containing the menu component.
     * @param app	    The main application.
     */
    public GUIMenuCheckboxItem(StructureContainer structCont, GUIBuilderApp app)
    {
	super("menuCheckboxItem"+counter);
	setName("menuCheckboxItem"+counter);
	counter++;
    ...
    /**
     * Constructs a new GUIMenuCheckboxItem with the specified label.
     *
     * @param label	   A string label for the button.
     * @param structCont   The StructureContainer containing the menu component.
     * @param app	   The main application.
     */
    public GUIMenuCheckboxItem(String label, StructureContainer structCont, GUIBuilderApp app)
    {
	super(label);
	setName("menuCheckboxItem"+counter);
	counter++;
    ...
    {
	GUIMenuPropertyDialog propertyDialog = new GUIMenuPropertyDialog(app, parentWindow, "CheckboxMenu Properties", this, structCont);
	...
	String initCode = "CheckboxMenuItem "+getName()+" = new CheckboxMenuItem(\""+getLabel()+"\");\n";
    ...
    {
	CheckboxMenuItem preview = new CheckboxMenuItem(getLabel(), getState());
	preview.setShortcut (getShortcut());
    ...
    {
	MenuPair[] result = {new MenuPair (" "+getLabel()+" (on/off)", this)};
	return (result);
    }
