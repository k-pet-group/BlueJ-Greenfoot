...
public class GUILabel extends Label implements GUIComponentLeaf
{
    ...
    /**
     * Constructs a GUILabel with no label.
     *
     ...
     */
    public GUILabel(GUIComponentNode parent, StructureContainer structCont, GUIBuilderApp app)
    {
	super();
	this.parent = parent;
    ...
    /**
     * Constructs a GUILabel with the specified label.
     *
     ...
     * @param app	    The main application.
     */
    public GUILabel(String label, GUIComponentNode parent, StructureContainer structCont, GUIBuilderApp app)
    {
	super(label);
	this.parent = parent;
	this.structCont = structCont;
    ...
    /**
     * Constructs a GUILabel with the specified label and alignment.
     *
     * @param label	    A string label for the button.
     ...
     * @param app	    The main application.
     */
    public GUILabel(String label, int alignment, GUIComponentNode parent, StructureContainer structCont, GUIBuilderApp app)
    {
	...
	StringBuffer initCode = new StringBuffer ("new Label (");
	initCode.append ("\""+getText()+"\"");
	if(changedAlignment)
	    initCode.append(","+getAlignmentText());
	initCode.append (")");
	...
	{
	    String variableCode = new String("Label "+getName()+" = ");
    ...
    /**
     * Converts the components alignment of the label value to a string.
     *
     * @return	A text string representing the alignment.
     */
