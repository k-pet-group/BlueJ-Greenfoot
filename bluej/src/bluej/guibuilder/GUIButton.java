...
public class GUIButton extends Button implements GUIComponentLeaf
{
    ...
    /**
     * Constructs a GUIButton with no label.
     *
     ...
     */
    public GUIButton(GUIComponentNode parent,StructureContainer structCont,GUIBuilderApp app)
    {
	super();
    ...
    /**
     * Constructs a GUIButton with the specified label.
     *
     ...
     * @param app	    The main application.
     */
    public GUIButton(String label,GUIComponentNode parent,StructureContainer structCont,GUIBuilderApp app)
    {
	super(label);
	setName("button"+counter+"_"+label);
	counter++;
        this.parent = parent;
        this.structCont = structCont;
        this.app =app;
	...
	StringBuffer initCode = new StringBuffer ("new Button (");
	if (!(getLabel().equals("")))
	    initCode.append ("\""+getLabel()+"\"");
	initCode.append (")");
	...
	{
	    String variableCode = new String("Button "+getName()+" = ");
    ...
    {
	Button preview = new Button(getLabel());
