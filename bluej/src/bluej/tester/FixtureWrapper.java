...
//    static final Color umlbg = Config.getItemColour("colour.uml.wrapper.bg");
    static final Color umlbg = Color.blue;
...
//    private DebuggerObject obj;
    ...
    public FixtureWrapper(PkgMgrFrame pmf, String instanceName, String className)
    {
        if(pmf.isEmptyFrame())
    ...
    private void drawUMLStyle(Graphics2D g)
    {
        ...
        g.setColor(shadow);
        g.fillRoundRect(10, 10, WIDTH - 10, HEIGHT - 15, 14, 14);
        g.setColor(umlbg);
        g.fillRoundRect(5, 5, WIDTH - 10, HEIGHT - 15, 14, 14);
        g.setColor(Color.black);
        g.drawRoundRect(5, 5, WIDTH - 10, HEIGHT - 15, 14, 14);
    ...
    protected void processMouseEvent(MouseEvent evt)
    {
        ...
        if(isPopupEvent(evt)) {
            ...
            if(evt.getClickCount() > 1)  // double click
                ...
                UnitTestBench bench = (UnitTestBench)getParent();
