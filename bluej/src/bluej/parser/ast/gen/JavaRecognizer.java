  ...
  astFactory = new ASTFactory(getTokenTypeToASTClassMap());
	...
	public final void classDefinition(
		...
		if ( inputState.guessing==0 ) {
			classDefinition_AST = (AST)currentAST.root;
				    	...
				    	setEndAst(classDefinition_AST, cb_AST);
	...
	public final void interfaceDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			interfaceDefinition_AST = (AST)astFactory.make( (new ASTArray(6)).add(astFactory.create(INTERFACE_DEF,"INTERFACE_DEF")).add(modifiers).add(tmp16_AST).add(tp_AST).add(ie_AST).add(cb_AST));
	...
	public final void enumDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			enumDefinition_AST = (AST)astFactory.make( (new ASTArray(5)).add(astFactory.create(ENUM_DEF,"ENUM_DEF")).add(modifiers).add(tmp18_AST).add(ic_AST).add(eb_AST));
	...
	public final void annotationDefinition(
		...
		if ( inputState.guessing==0 ) {
			...
			annotationDefinition_AST = (AST)astFactory.make( (new ASTArray(4)).add(astFactory.create(ANNOTATION_DEF,"ANNOTATION_DEF")).add(modifiers).add(tmp21_AST).add(ab_AST));
 ...
 */
	...
	public final void variableDefinitions(
		...
		do {
			if ((LA(1)==COMMA)) {
				...
				match(COMMA);
				if ( inputState.guessing==0 ) {
					setEndToken(lastVarDeclarator, comma);
				}
				variableDeclarator(getASTFactory().dupTree(mods),
							   getASTFactory().dupTree(t));
				vdn_AST = (AST)returnAST;
				astFactory.addASTChild(currentAST, returnAST);
				if ( inputState.guessing==0 ) {
					lastVarDeclarator = vdn_AST;
				}
			}
			else {
				break _loop143;
	...
	public final void typeArguments(
		...
		{
		if (((LA(1) >= GT && LA(1) <= BSR)) && (_tokenSet_5.member(LA(2)))) {
			typeArgumentsEnd();
			astFactory.addASTChild(currentAST, returnAST);
		}
	...
	public final void typeParameters() throws RecognitionException, TokenStreamException {
		...
		if (!(gtToReconcile==1))
		  throw new SemanticException("gtToReconcile==1");
		if ( inputState.guessing==0 ) {
			gtToReconcile=0;
		}
		if (!((currentLtLevel != 0) || ltCounter == currentLtLevel))
			...
			case LITERAL_double:
			{
				...
				if ((LA(1)==IDENT) && (LA(2)==LPAREN)) {
					...
					if ((LA(1)==IDENT) && (LA(2)==LPAREN)) {
						...
						if ( inputState.guessing==0 ) {
							field_AST = (AST)currentAST.root;
							field_AST = (AST)astFactory.make( (new ASTArray(8)).add(astFactory.create(METHOD_DEF,"METHOD_DEF")).add(mods_AST).add(tp_AST).add((AST)astFactory.make( (new ASTArray(2)).add(astFactory.create(TYPE,"TYPE")).add(rt_AST))).add(tmp76_AST).add(param_AST).add(tc_AST).add(s2_AST));
							currentAST.root = field_AST;
							currentAST.child = field_AST!=null &&field_AST.getFirstChild()!=null ?
								field_AST.getFirstChild() : field_AST;
							currentAST.advanceChildToEnd();
		...
		case LITERAL_enum:
		{
			...
			case LITERAL_double:
			{
				...
				if ((LA(1)==IDENT) && (LA(2)==LPAREN)) {
					...
					if ( inputState.guessing==0 ) {
						enumConstantField_AST = (AST)currentAST.root;
						enumConstantField_AST = (AST)astFactory.make( (new ASTArray(8)).add(astFactory.create(METHOD_DEF,"METHOD_DEF")).add(mods_AST).add(tp_AST).add((AST)astFactory.make( (new ASTArray(2)).add(astFactory.create(TYPE,"TYPE")).add(rt_AST))).add(tmp92_AST).add(param_AST).add(tc_AST).add(s2_AST));
						currentAST.root = enumConstantField_AST;
						currentAST.child = enumConstantField_AST!=null &&enumConstantField_AST.getFirstChild()!=null ?
							enumConstantField_AST.getFirstChild() : enumConstantField_AST;
						currentAST.advanceChildToEnd();
...
/** Catch obvious constructor calls, but not the expr.super(...) calls */
	...
	public final void statement() throws RecognitionException, TokenStreamException {
		...
		AST semi4_AST = null;
		Token  contstmt = null;
		AST contstmt_AST = null;
		Token  semi5 = null;
		AST semi5_AST = null;
		Token  retstmt = null;
		AST retstmt_AST = null;
		Token  semi6 = null;
		AST semi6_AST = null;
		Token  swstmt = null;
		AST swstmt_AST = null;
		...
		{
			ifstmt = LT(1);
			ifstmt_AST = astFactory.create(ifstmt);
			astFactory.makeASTRoot(currentAST, ifstmt_AST);
			match(LITERAL_if);
			match(LPAREN);
			expression();
			astFactory.addASTChild(currentAST, returnAST);
			match(RPAREN);
			statement();
			stmt2_AST = (AST)returnAST;
			astFactory.addASTChild(currentAST, returnAST);
			if ( inputState.guessing==0 ) {
				setEndAst(ifstmt_AST, stmt2_AST);
			}
			{
			if ((LA(1)==LITERAL_else) && (_tokenSet_20.member(LA(2)))) {
				match(LITERAL_else);
				statement();
				stmt3_AST = (AST)returnAST;
				astFactory.addASTChild(currentAST, returnAST);
				if ( inputState.guessing==0 ) {
					setEndAst(ifstmt_AST, stmt3_AST);
				}
			}
		...
		{
			wstmt = LT(1);
			wstmt_AST = astFactory.create(wstmt);
			astFactory.makeASTRoot(currentAST, wstmt_AST);
			match(LITERAL_while);
			match(LPAREN);
			expression();
			astFactory.addASTChild(currentAST, returnAST);
			match(RPAREN);
			statement();
			stmt4_AST = (AST)returnAST;
			astFactory.addASTChild(currentAST, returnAST);
			if ( inputState.guessing==0 ) {
				
						setEndAst(wstmt_AST, stmt4_AST);
		...
		{
			dostmt = LT(1);
			dostmt_AST = astFactory.create(dostmt);
			astFactory.makeASTRoot(currentAST, dostmt_AST);
			match(LITERAL_do);
			statement();
			astFactory.addASTChild(currentAST, returnAST);
			match(LITERAL_while);
			...
			match(RPAREN);
			semi3 = LT(1);
			semi3_AST = astFactory.create(semi3);
			match(SEMI);
			if ( inputState.guessing==0 ) {
				
						setEndToken(dostmt_AST, semi3);
		...
		{
			brstmt = LT(1);
			brstmt_AST = astFactory.create(brstmt);
			astFactory.makeASTRoot(currentAST, brstmt_AST);
			match(LITERAL_break);
			{
			switch ( LA(1)) {
			case IDENT:
			...
			semi4 = LT(1);
			semi4_AST = astFactory.create(semi4);
			match(SEMI);
			if ( inputState.guessing==0 ) {
				setEndToken(brstmt_AST, semi4);
			}
			statement_AST = (AST)currentAST.root;
			break;
		}
		...
		{
			contstmt = LT(1);
			contstmt_AST = astFactory.create(contstmt);
			astFactory.makeASTRoot(currentAST, contstmt_AST);
			...
			semi5 = LT(1);
			semi5_AST = astFactory.create(semi5);
			match(SEMI);
			if ( inputState.guessing==0 ) {
				setEndToken(contstmt_AST, semi5);
			}
			statement_AST = (AST)currentAST.root;
			break;
		}
		...
		{
			retstmt = LT(1);
			retstmt_AST = astFactory.create(retstmt);
			astFactory.makeASTRoot(currentAST, retstmt_AST);
			...
			semi6 = LT(1);
			semi6_AST = astFactory.create(semi6);
			match(SEMI);
			if ( inputState.guessing==0 ) {
				setEndToken(retstmt_AST, semi6);
			}
			statement_AST = (AST)currentAST.root;
			break;
		}
		...
		{
			swstmt = LT(1);
			swstmt_AST = astFactory.create(swstmt);
			astFactory.makeASTRoot(currentAST, swstmt_AST);
			...
			rcurly = LT(1);
			rcurly_AST = astFactory.create(rcurly);
			match(RCURLY);
			if ( inputState.guessing==0 ) {
				
							setEndToken(swstmt_AST, rcurly);
		...
		{
			throwkw = LT(1);
			throwkw_AST = astFactory.create(throwkw);
			astFactory.makeASTRoot(currentAST, throwkw_AST);
			match(LITERAL_throw);
			expression();
			astFactory.addASTChild(currentAST, returnAST);
			semi7 = LT(1);
			semi7_AST = astFactory.create(semi7);
			match(SEMI);
			if ( inputState.guessing==0 ) {
				setEndToken(throwkw_AST, semi7);
			}
			statement_AST = (AST)currentAST.root;
			break;
		}
		...
		{
			assertkw = LT(1);
			assertkw_AST = astFactory.create(assertkw);
			astFactory.makeASTRoot(currentAST, assertkw_AST);
			...
			semi8 = LT(1);
			semi8_AST = astFactory.create(semi8);
			match(SEMI);
			if ( inputState.guessing==0 ) {
				
							setEndToken(assertkw_AST, semi8);
		...
		case SEMI:
		{
			...
			match(SEMI);
			if ( inputState.guessing==0 ) {
				s_AST.setType(EMPTY_STAT); setEndToken(s_AST,s);
			}
			statement_AST = (AST)currentAST.root;
			break;
		}
		default:
			...
			if ( synPredMatched183 ) {
				...
				astFactory.addASTChild(currentAST, returnAST);
				if ( inputState.guessing==0 ) {
					setEndAst(c_AST, stmt_AST);
				}
				statement_AST = (AST)currentAST.root;
			}
			else if ((LA(1)==LITERAL_synchronized) && (LA(2)==LPAREN)) {
				synckw = LT(1);
				synckw_AST = astFactory.create(synckw);
				astFactory.makeASTRoot(currentAST, synckw_AST);
				match(LITERAL_synchronized);
				match(LPAREN);
				expression();
				astFactory.addASTChild(currentAST, returnAST);
				match(RPAREN);
				compoundStatement();
				stmt5_AST = (AST)returnAST;
				astFactory.addASTChild(currentAST, returnAST);
				if ( inputState.guessing==0 ) {
					
								setEndAst(synckw_AST, stmt5_AST);
 ...
 */
	...
	public final void tryBlock() throws RecognitionException, TokenStreamException {
		...
		AST trykw_AST = null;
		AST hndlr_AST = null;
		AST fclause_AST = null;
		
		trykw = LT(1);
		trykw_AST = astFactory.create(trykw);
		astFactory.makeASTRoot(currentAST, trykw_AST);
		match(LITERAL_try);
		compoundStatement();
		astFactory.addASTChild(currentAST, returnAST);
		{
		...
		do {
			if ((LA(1)==LITERAL_catch)) {
				handler();
				hndlr_AST = (AST)returnAST;
				astFactory.addASTChild(currentAST, returnAST);
				if ( inputState.guessing==0 ) {
					setEndAst(trykw_AST, hndlr_AST);
				}
			}
			else {
				break _loop215;
		...
		{
			finallyClause();
			fclause_AST = (AST)returnAST;
			astFactory.addASTChild(currentAST, returnAST);
			if ( inputState.guessing==0 ) {
				setEndAst(trykw_AST, fclause_AST);
			}
			break;
		}
		case FINAL:
	...
	public final void forInit() throws RecognitionException, TokenStreamException {
		...
		else if ((_tokenSet_27.member(LA(1))) && (_tokenSet_35.member(LA(2)))) {
			expressionList();
			astFactory.addASTChild(currentAST, returnAST);
		}
		else if ((LA(1)==SEMI)) {
	...
	public final void traditionalForStatement() throws RecognitionException, TokenStreamException {
		
		returnAST = null;
		ASTPair currentAST = new ASTPair();
		AST traditionalForStatement_AST = null;
		...
		forIter();
		astFactory.addASTChild(currentAST, returnAST);
		traditionalForStatement_AST = (AST)currentAST.root;
		returnAST = traditionalForStatement_AST;
	}
	...
	public final void handler() throws RecognitionException, TokenStreamException {
		...
		Token  catchkw = null;
		AST catchkw_AST = null;
		AST cs_AST = null;
		
		catchkw = LT(1);
		catchkw_AST = astFactory.create(catchkw);
		astFactory.makeASTRoot(currentAST, catchkw_AST);
		match(LITERAL_catch);
		match(LPAREN);
		parameterDeclaration();
		astFactory.addASTChild(currentAST, returnAST);
	...
	public final void unaryExpression() throws RecognitionException, TokenStreamException {
		...
		case MINUS:
		{
			...
			match(MINUS);
			if ( inputState.guessing==0 ) {
				tmp178_AST.setType(UNARY_MINUS);
			}
			unaryExpression();
			astFactory.addASTChild(currentAST, returnAST);
			unaryExpression_AST = (AST)currentAST.root;
 ...
 */
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { -4611682170136690686L, 966359252993L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_0 = new BitSet(mk_tokenSet_0());
	private static final long[] mk_tokenSet_1() {
		long[] data = { 4611689866718085122L, 966359253001L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_1 = new BitSet(mk_tokenSet_1());
	private static final long[] mk_tokenSet_2() {
		long[] data = { 4611689866718085120L, 966359252993L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_2 = new BitSet(mk_tokenSet_2());
	private static final long[] mk_tokenSet_3() {
		long[] data = { 3848290697216L, 2139095041L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_5() {
		long[] data = { 4611686018427387904L, -4611574834604802434L, 32767L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_5 = new BitSet(mk_tokenSet_5());
	private static final long[] mk_tokenSet_6() {
		long[] data = { 6917532875931779072L, -3458782106006585345L, 137438953471L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_6 = new BitSet(mk_tokenSet_6());
	private static final long[] mk_tokenSet_7() {
		long[] data = { 0L, 8836899397768L, 137432137728L, 0L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_9() {
		long[] data = { 0L, 8802539659400L, 137432137728L, 0L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_11() {
		long[] data = { 4611689866718085120L, 5471784132955L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_11 = new BitSet(mk_tokenSet_11());
	private static final long[] mk_tokenSet_12() {
		long[] data = { 3848290697216L, 966363439369L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_12 = new BitSet(mk_tokenSet_12());
	private static final long[] mk_tokenSet_13() {
		long[] data = { 3848290697216L, 970658406683L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_17() {
		long[] data = { 549755813888L, 2151669768L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_20() {
		long[] data = { 4611689866718085120L, 864277892467515529L, 137432137728L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_20 = new BitSet(mk_tokenSet_20());
	private static final long[] mk_tokenSet_21() {
		long[] data = { 4611689866718085120L, 864277961186992265L, 137432137728L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_21 = new BitSet(mk_tokenSet_21());
	private static final long[] mk_tokenSet_22() {
		long[] data = { 4611689866718085120L, -3747335747166798405L, 137438953471L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_22 = new BitSet(mk_tokenSet_22());
	private static final long[] mk_tokenSet_23() {
		long[] data = { 4611689866718085120L, 1152792011338670217L, 137432137728L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_23 = new BitSet(mk_tokenSet_23());
	private static final long[] mk_tokenSet_24() {
		long[] data = { 4611689866718085120L, -57183194579525L, 137438953471L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_24 = new BitSet(mk_tokenSet_24());
	private static final long[] mk_tokenSet_25() {
		long[] data = { 3848290697216L, 4290764809L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_25 = new BitSet(mk_tokenSet_25());
	private static final long[] mk_tokenSet_26() {
		long[] data = { 3848290697216L, 4290765083L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_26 = new BitSet(mk_tokenSet_26());
	private static final long[] mk_tokenSet_27() {
		long[] data = { 0L, 8800392175752L, 137432137728L, 0L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_29() {
		long[] data = { 3848290697216L, 141725532161L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_29 = new BitSet(mk_tokenSet_29());
	private static final long[] mk_tokenSet_30() {
		long[] data = { 3848290697216L, 141725532169L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_30 = new BitSet(mk_tokenSet_30());
	private static final long[] mk_tokenSet_31() {
		long[] data = { 0L, 8834751914120L, 137432137728L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_31 = new BitSet(mk_tokenSet_31());
	private static final long[] mk_tokenSet_32() {
		long[] data = { 4611689866718085120L, 8804678754441L, 137432137728L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_32 = new BitSet(mk_tokenSet_32());
	private static final long[] mk_tokenSet_33() {
		long[] data = { 4611689866718085120L, -4611676097052934213L, 137438953471L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_33 = new BitSet(mk_tokenSet_33());
	private static final long[] mk_tokenSet_34() {
		long[] data = { 0L, 79169136353416L, 137432137728L, 0L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_39() {
		long[] data = { 0L, 8800392175752L, 137304735744L, 0L, 0L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_42() {
		long[] data = { 6917532875931779072L, -3458821688425185345L, 137438953471L, 0L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_42 = new BitSet(mk_tokenSet_42());
	private static final long[] mk_tokenSet_43() {
		long[] data = { 0L, 8800392175756L, 137432137728L, 0L, 0L, 0L};
		return data;
	}
