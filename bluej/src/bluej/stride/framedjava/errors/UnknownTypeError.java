...
public class UnknownTypeError extends DirectSlotError
{
     ...
     * @param replace An action which takes a Map containing the replacement type name ("type" key) and if any the package ("package" key),
     *               and substitutes it for the erroneous type name in the original frame.
