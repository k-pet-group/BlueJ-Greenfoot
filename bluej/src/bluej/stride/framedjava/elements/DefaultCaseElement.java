...
public class DefaultCaseElement extends ContainerCodeElement implements JavaSingleLineDebugHandler, JavaContainerDebugHandler
{
    ...
    {
        frame = new DefaultCaseFrame(editor, isEnable());
        for (CodeElement c : contents)
        {
