	   ...
	   throws IOException
  {
	...
	void doEverything(String[] args) {
		...
		try {
			...
			System.err.println("Error: cannot open grammar file " + grammarFile);
			help();
			System.exit(1);
		}
		...
		try {
			...
			System.err.println("Unhandled parser error: " + mt.getMessage());
		}
		catch (NoViableAltException nva) {
			System.err.println("Unhandled parser error: " + nva.getMessage());
		}
	 ...
	 */
	public void error(String s, int line) {
		hasError = true;
...
private static void help() {
	...
	System.err.println("  -traceTreeWalker  have tree walker rules call traceIn/traceOut.");
}
	public static void main(String[] args) {
		System.err.println("ANTLR Parser Generator   Version "+
							ANTLRParser.version+"   1989-1998 MageLang Institute");
		try {
			if ( args.length==0 ) {
				help();
			}
...
private void processArguments(String[] args) {
	 ...
	 * @param line The grammar file line number on which the error occured
	 */
	public static void warning(String s, int line) {
