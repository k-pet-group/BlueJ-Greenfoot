...
public abstract class CodeGenerator {
	...
	protected String extractIdOfAction(String s, int line) {
		...
		tool.warning("Ill-formed action", line);
		return "";
	}
	...
	//
	// Support routines, can be used by all code-generators
	//
	...
	protected void genTokenInterchange(TokenManager tm) throws IOException {
		...
		currentOutput = antlr.Tool.openOutputFile(tm.getName() + "TokenTypes.txt");
	...
	/** Get a string for an expression to generate creating of an AST node
	  ...
	  */
	public abstract String getASTCreateString(String str);
	...
	protected String processActionForTreeSpecifiers(String actionStr, int line, RuleBlock currentRule, ActionTransInfo tInfo) {
		...
		if ( (grammar.buildAST && actionStr.indexOf('#') != -1) ||
			...
			antlr.actions.ActionLexer lexer = new antlr.actions.ActionLexer(actionStr, currentRule, this, tInfo);
			...
			try {
				...
				antlr.Tool.panic("IO error reading action:"+actionStr);
				return actionStr;
			}
		}
		return actionStr;
	...
	protected void setGrammar(Grammar g) {
		...
		if (grammar.hasOption("codeGenDebug")) {
			...
			if (t.getText().equals("true")) {
				...
				tool.error("option 'codeGenDebug' must be true or false", t.getLine());
			}
		}
	}
