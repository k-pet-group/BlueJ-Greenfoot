	...
	public void setOption(Token key, Token value) {
		if (key.getText().equals("defaultErrorHandler")) {
			if (value.getText().equals("true")) {
				...
				grammar.tool.error("Value for defaultErrorHandler must be true or false", key.getLine());
			}
		} 
		else if (key.getText().equals("testLiterals")) {
			if (!(grammar instanceof LexerGrammar)) {
				grammar.tool.error("testLiterals option only valid for lexer rules", key.getLine());
			}
			else {
				if (value.getText().equals("true")) {
					testLiterals = true;
					...
					grammar.tool.error("Value for testLiterals must be true or false", key.getLine());
				}
			}
		}
		else if (key.getText().equals("ignore")) {
			if (!(grammar instanceof LexerGrammar)) {
				grammar.tool.error("ignore option only valid for lexer rules", key.getLine());
			}
			else {
			...
			if (!(grammar instanceof LexerGrammar)) {
				grammar.tool.error("paraphrase option only valid for lexer rules", key.getLine());
			}
			else {
			...
			grammar.tool.error("Invalid rule option: " + key.getText(), key.getLine());
		}
	}
