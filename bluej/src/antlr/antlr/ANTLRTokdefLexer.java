...
public class ANTLRTokdefLexer extends antlr.CharScanner implements ANTLRTokdefParserTokenTypes, Tokenizer
 {
...
tryAgain:
	...
	public final void mSTRING(boolean _createToken) throws ScannerException, IOException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = STRING;
		int _saveIndex;
	...
	public final void mID(boolean _createToken) throws ScannerException, IOException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = ID;
		int _saveIndex;
	...
	public final void mINT(boolean _createToken) throws ScannerException, IOException {
		...
		do {
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				if ( _cnt40>=1 ) { break _loop40; } else {throw new ScannerException("no viable alt for char: "+(char)LA(1),getLine());}
			}
