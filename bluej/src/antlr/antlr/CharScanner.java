 ...
 * 
 * modified by Michael Kolling (mik@csse.monash.edu.au) to track columns
 */
...
public abstract class CharScanner implements Tokenizer {
    ...
    protected int column = 0;				// current column
    ...
    public void newline() { line++; column=0;}
    public void panic() {
    ...
    public void setLine(int line) { this.line = line; column=0; }
