...
public class ANTLRLexer extends antlr.CharScanner implements ANTLRTokenTypes, Tokenizer
 {
...
public ANTLRLexer(InputBuffer ib) {
	...
	literals.put(new ANTLRHashString("Lexer", this), new Integer(10));
	literals.put(new ANTLRHashString("exception", this), new Integer(37));
	literals.put(new ANTLRHashString("class", this), new Integer(8));
	literals.put(new ANTLRHashString("lexclass", this), new Integer(7));
	literals.put(new ANTLRHashString("public", this), new Integer(31));
	literals.put(new ANTLRHashString("header", this), new Integer(4));
	literals.put(new ANTLRHashString("options", this), new Integer(48));
	literals.put(new ANTLRHashString("tokens", this), new Integer(25));
	...
	literals.put(new ANTLRHashString("TreeParser", this), new Integer(11));
