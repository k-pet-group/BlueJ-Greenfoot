...
public class ShowReferencesRefactorerTest extends DefinitionLookupTest {
  File file;

  public ShowReferencesRefactorerTest(String name) {
    super(name);
  }
  ...
  public void testShowReferencesAtLeftEdge() {
    ShowReferencesRefactorer refactorer = new ShowReferencesRefactorer();
  ...
  public void testShowReferencesMiddle() {
    ShowReferencesRefactorer refactorer = new ShowReferencesRefactorer();
    refactorer.setup(table);
  ...
  public static void main(String[] args) {
    junit.swingui.TestRunner.run(ShowReferencesRefactorerTest.class);
  }
}