...
// $Id: ShowReferencesRefactorer.java 1011 2001-11-22 10:36:26Z ajp $
...
public class ShowReferencesRefactorer extends LookupRefactorer {

  public ShowReferencesRefactorer() {
    super();
  }

  public void apply(Hook hook) throws Exception {
    Occurrence location = hook.makeOccurrence();
    hook.showReferences(refactor(location));
  }
