...
// $Id: LabeledStatPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a label statement
 */

public class LabeledStatPrinter extends ChildIgnoringPrinter {
  public LabeledStatPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a label statement to the printer
   *
  ...
  public void printSelf(PrettyPrinter printout) throws IOException {
    ...
    SymTabAST rest = (SymTabAST)ident.getNextSibling();
