...
// $Id: GotoPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a break or continue statement
 */

public class GotoPrinter extends ChildIgnoringPrinter {
  public GotoPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a break or continue statement to the PrettyPrinter.  Also
   * prints the label if it exsists
   *
