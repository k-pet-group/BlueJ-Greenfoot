...
//$Id: ArrayDeclPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints an Array Declaration
 */

public class ArrayDeclPrinter extends ChildIgnoringPrinter {
  public ArrayDeclPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

/**
 * prints an array declaration with enclosing brackets
 *
 ...
 */
  public void printSelf(PrettyPrinter printout) throws IOException {
    ...
    if (PrinterProperties.hasSpaceBeforeArrayDeclarator())
    {
        printout.print(" ");
    }
    if (child != null) {
      if (child.getType() == JavaTokenTypes.EXPR) {
        printout.print("[");
