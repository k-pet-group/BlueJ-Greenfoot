...
// $Id: DotPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a "dotted name" (a JavaTokenTypes.DOT node)
 */

public class DotPrinter extends ChildIgnoringPrinter {
  public DotPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a dotted name to the PrettyPrinter
   *
   ...
   * @param printout the PrettyPrinter to print to
   */
  protected void printDot(PrettyPrinter printout) throws IOException {
    printout.print(".");
  }
}
