...
// $Id: WhilePrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a while loop
 */

public class WhilePrinter extends ChildIgnoringPrinter {
  public WhilePrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  public void printSelf(PrettyPrinter printout) throws IOException {
    SymTabAST condition = nodeToPrint.getFirstChildOfType(JavaTokenTypes.EXPR);
    SymTabAST body = (SymTabAST)condition.getNextSibling();
