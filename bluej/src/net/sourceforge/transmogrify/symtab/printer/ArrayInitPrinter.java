...
//$Id: ArrayInitPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints an Array Initializer
 */

public class ArrayInitPrinter extends CommaListPrinter {
  public ArrayInitPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

/**
 * prints an array initialization with enclosing braces
 *
