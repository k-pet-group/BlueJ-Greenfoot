...
// $Id: VariableDefPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints out a variable definition
 */

public class VariableDefPrinter extends ChildIgnoringPrinter {
  public VariableDefPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a variable definition to the printer
   *
