...
// $Id: PrefixOperatorPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a prefix operator
 */

public class PrefixOperatorPrinter extends ChildIgnoringPrinter {
  public PrefixOperatorPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a prefix operator to the printout
   *
