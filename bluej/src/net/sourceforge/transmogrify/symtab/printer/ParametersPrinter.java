...
// $Id: ParametersPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a parameter list
 */

public class ParametersPrinter extends CommaListPrinter {
  public ParametersPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a parameter list to the printer
   *
