...
// $Id: PostfixOperatorPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a postfix operator
 */

public class PostfixOperatorPrinter extends ChildIgnoringPrinter {
  public PostfixOperatorPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a postfix operator to the printer
   *
