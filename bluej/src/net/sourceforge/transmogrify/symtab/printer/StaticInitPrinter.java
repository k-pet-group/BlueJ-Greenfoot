...
// $Id: StaticInitPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a static initializer
 */

public class StaticInitPrinter extends ChildIgnoringPrinter {
  public StaticInitPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a static initializer to the printer
   *
   * @param printout the PrettyPrinter to print to
   */
  public void printSelf(PrettyPrinter printout) throws IOException {
    printout.print("static");
