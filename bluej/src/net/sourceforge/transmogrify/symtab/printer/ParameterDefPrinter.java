...
// $Id: ParameterDefPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a single parameter
 */

public class ParameterDefPrinter extends ChildIgnoringPrinter {
  public ParameterDefPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a single parameter to the printer
   *
