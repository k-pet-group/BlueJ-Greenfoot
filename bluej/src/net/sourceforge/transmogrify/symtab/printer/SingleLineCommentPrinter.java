...
// $Id: SingleLineCommentPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a single line comment
 */

public class SingleLineCommentPrinter extends DefaultPrinter {
  public SingleLineCommentPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a single line comment to the printer
   *
