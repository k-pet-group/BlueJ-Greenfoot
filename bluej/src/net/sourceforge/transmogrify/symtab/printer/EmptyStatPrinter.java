...
// $Id: EmptyStatPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints an empty statement ( ";" )
 */

public class EmptyStatPrinter extends DefaultPrinter {
  public EmptyStatPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints an empty statement to the PrettyPrinter
   *
