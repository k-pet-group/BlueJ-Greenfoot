...
//$Id: BinaryOperatorPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a Binary Operator and its operands
 */

public class BinaryOperatorPrinter extends ChildIgnoringPrinter {
  public BinaryOperatorPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

/**
 * prints the binary operator to a PrettyPrinter
 *
