...
// $Id: SwitchPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a switch statement
 */

public class SwitchPrinter extends DefaultPrinter {
  public SwitchPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a switch statement to the printer
   *
   * @param printout the PrettyPrinter to print to
   */
  public void printSelf(PrettyPrinter printout) throws IOException {
    SymTabAST expr = nodeToPrint.getFirstChildOfType(JavaTokenTypes.EXPR);
    ...
    // ignore the first child, which is the EXPR node
    children.next();
