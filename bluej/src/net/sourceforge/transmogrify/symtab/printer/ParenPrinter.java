...
// $Id: ParenPrinter.java 1014 2001-11-30 03:28:10Z ajp $

/**
 * prints a parenthesized statement
 */

public class ParenPrinter extends ChildIgnoringPrinter {
  public ParenPrinter(SymTabAST nodeToPrint) {
    super(nodeToPrint);
  }

  /**
   * prints a parenthesized statement to the printer
   *
