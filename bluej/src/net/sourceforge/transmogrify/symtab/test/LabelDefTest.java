...
// $Id: LabelDefTest.java 1014 2001-11-30 03:28:10Z ajp $
...
public class LabelDefTest extends TestCase {
  ...
  public void testLabelDefinition() {
    IDefinition defOfReference = query.getDefinition("bar",
                                                    new Occurrence(new File("test/LabelTest.java"),
                                                                   9, 17));

    IDefinition defOfDefinition = query.getDefinition("bar",
                                                     new Occurrence(new File("test/LabelTest.java"),
                                                                    5, 5));
  ...
  public static void main(String [] args) {
    junit.swingui.TestRunner.main(new String [] { LabelDefTest.class.getName() });
  }
}
