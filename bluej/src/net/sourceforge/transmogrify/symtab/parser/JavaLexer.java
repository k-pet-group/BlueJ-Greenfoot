// $ANTLR 2.7.0: "src/net/sourceforge/transmogrify/symtab/parser/java.g" -> "JavaLexer.java"$
...
tryAgain:
	...
	public final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			default:
				...
				else if ((LA(1)=='\r') && ((LA(2) >= '\3' && LA(2) <= '\377')) && ((LA(3) >= '\3' && LA(3) <= '\377')) && (true)) {
					match('\r');
					newline();
				}
			else {
	...
	protected final void mESC(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		case 'u':
		{
			...
			do {
				if ((LA(1)=='u')) {
					...
					if ( _cnt257>=1 ) { break _loop257; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine());}
				}
		...
		case '0':  case '1':  case '2':  case '3':
		{
			...
			{
			if (((LA(1) >= '0' && LA(1) <= '7')) && ((LA(2) >= '\3' && LA(2) <= '\377')) && (true) && (true)) {
				{
				matchRange('0','7');
				}
				{
				...
				else if (((LA(1) >= '\3' && LA(1) <= '\377')) && (true) && (true) && (true)) {
				}
				else {
					throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine());
				}
		...
		case '4':  case '5':  case '6':  case '7':
		{
			...
			{
			if (((LA(1) >= '0' && LA(1) <= '9')) && ((LA(2) >= '\3' && LA(2) <= '\377')) && (true) && (true)) {
				{
				matchRange('0','9');
				}
			}
			...
			if (((LA(1) >= '0' && LA(1) <= '9'))) {
				...
				do {
					if (((LA(1) >= '0' && LA(1) <= '9'))) {
						...
						if ( _cnt275>=1 ) { break _loop275; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine());}
					}
				...
				case 'X':  case 'x':
				{
					...
					do {
						if ((_tokenSet_4.member(LA(1))) && (true) && (true) && (true)) {
							...
							if ( _cnt282>=1 ) { break _loop282; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine());}
						}
