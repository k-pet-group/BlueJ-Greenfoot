/*
 ...
 Copyright (C) 1999-2009,2010,2011,2012,2013,2014,2015,2016,2017,2018,2019,2020,2021,2022,2023,2024,2025,2026  Michael Kolling and John Rosenberg
    ...
    implements InvokeListener
{
    ...
    public boolean generateSkeleton(String template, SourceType sourceType, boolean includeFullContent)
    {
        ...
        if (template == null) {
            ...
            switch (sourceType) {
                case Java:
                    success = role.generateSkeleton(template, getPackage(), getBaseName(), getJavaSourceFile().getPath(), includeFullContent);
                    break;
                case Stride:
    ...
    {
        DataCollector.showErrorMessage(getPackage(), identifier, message, quickFixes);
    }
