/*
 ...
 Copyright (C) 1999-2009,2011,2016,2019,2020,2026  Michael Kolling and John Rosenberg
...
public class MethodView extends CallableView implements Comparable<MethodView>
{
    ...
    // For Kotlin companion-object methods: the name of the companion (and of the
    // static receiver field on the enclosing class, e.g. "Companion"). Null for
    // ordinary Java/Kotlin methods.
    private final String companionReceiverName;

    // Strings
    @OnThread(Tag.Any)
    static final String autoGeneratedString = Config.getString("methodview.autogenerated");

    /**
     * Constructor.
     *
     * @param view           the declaring class view
     * @param method         the reflected method
     * @param autoGenerated  true if this method is a compiler-generated property accessor
     */
    public MethodView(View view, Method method, boolean autoGenerated) throws ClassNotFoundException
    {
        this(view, method, autoGenerated, null);
    }
     ...
     * @param method                 the reflected method
     * @param autoGenerated          true if this method is a compiler-generated property accessor
     * @param companionReceiverName  for a Kotlin companion-object method, the companion name (also
     *                               the static receiver field on the enclosing class, e.g. "Companion");
     *                               null for ordinary methods
     */
    public MethodView(View view, Method method, boolean autoGenerated, String companionReceiverName)
            throws ClassNotFoundException
    {
        super(view);
        this.method = method;
        this.autoGenerated = autoGenerated;
        this.companionReceiverName = companionReceiverName;
        jtReturnType = JavaUtils.getJavaUtils().getReturnType(method);
    }

    /**
     * Constructor for non-auto-generated methods (backward compatibility).
     */
    public MethodView(View view, Method method) throws ClassNotFoundException
    {
        this(view, method, false, null);
    }

    /**
     * Returns whether this method is a compiler-generated property accessor
     * (e.g. a Kotlin property getter or setter).
     *
    ...
    {
        return companionReceiverName != null;
    }

    /**
     * True for Kotlin companion-object methods too — they are callable without an
     * instance (invoked as {@code Foo.Companion.method()}) though their reflected
     * modifiers are non-static; {@link #getModifiers()} stays truthful.
     */
    @Override
    public boolean isStatic()
    {
        return companionReceiverName != null || super.isStatic();
    }

    /**
     * For a Kotlin companion-object method, the name of the static receiver field
     * on the enclosing class (e.g. {@code "Companion"}), used to build the
     * {@code Foo.Companion.method()} invocation. Null for ordinary methods.
     */
    public String getCompanionReceiverName()
    {
        return companionReceiverName;
    }
    ...
    /**
     * Returns a suffix indicating whether the method is auto-generated.
     * If the method is auto-generated, the suffix is formatted as:
     * "   [ autoGeneratedString ]", otherwise an empty string is returned.
     *
     * @return A formatted suffix string if the method is auto-generated, or an empty string if not.
     */
