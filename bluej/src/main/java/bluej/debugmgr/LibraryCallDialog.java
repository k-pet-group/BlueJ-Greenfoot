/*
 ...
 Copyright (C) 1999-2009,2010,2016,2018,2021,2026  Michael Kolling and John Rosenberg
    ...
    private void makeDialog()
    {
        ...
        methodList.setCellFactory(v -> {
            ListCell<CallableView> cell = new TextFieldListCell<>(new StringConverter<CallableView>()
            {
                ...
                {
                    String desc = object.getShortDesc();
                    if (object instanceof MethodView) {
                        desc += ((MethodView) object).getAutoGeneratedSuffix();
                    }
                    return desc;
                }
