...
public class SubmitDialog implements ActionListener
{
    ...
    // The chosen submission scheme is here.
    private JButton browseButton;
    // When you press this the browsing window opens
...
//  private JProgressBar progressBar;
    ...
    public SubmitDialog(Stat i_stat)
    {
        ...
        // You need this to place the windows on Unix
     ...
     *
     * @param  pRootDir  Description of the Parameter
     * @param  pName     Description of the Parameter
     */
    public void submitThis(File pRootDir, String pName)
    {
        mainFrame.pack();
        // You need this, othervise it does not resize right, Damiano
        mainFrame.setVisible(true);
        // In ANY case I MUST show something to the user
     ...
     *
     * @param  aMessage  Description of the Parameter
     */
     ...
     *
     * @param  curScheme  Description of the Parameter
     */
