...
/**
 * <p>
 * This implementation class implements the 'Serial' interface using the
 * WiringPi Serial library.</p>
 *
 * <p>
...
public class SerialImpl implements Serial
{
    ...
    /**
     * This method is call to open a serial port for communication. Throws
     * SerialException on error.
     *
     * @see #DEFAULT_COM_PORT
     *
     * @param device The device address of the serial port to access. You can
     * use constant 'DEFAULT_COM_PORT' if you wish to access the default serial
     * port provided via the GPIO header.
     ...
     *
     * @see #open(String, int)
     * @return a value of 'true' is returned if the serial port is already in
     * the closed state.
     */
    ...
    /**
     * This method is called to immediately flush the serial data transmit
     * buffer and force any pending data to be sent to the serial port
     * immediately.
     */
    ...
    /**
     * <p>
     * This method will read the next character available from the serial port
     * receive buffer.</p>
     * <p>
     * <b>NOTE: If a serial data listener has been implemented and registered
     * with this class, then this method should not be called directly. A
     * background thread will be running to collect received data from the
     * serial port receive buffer and the received data will be available on via
     * the event.</b>
     * </p>
     *
    ...
    /**
     * This method is called to submit a single character of data to the serial
    ...
    /**
     * This method is called to submit a character array of data to the serial
     * port transmit buffer.
     *
    ...
    /**
     * This method is called to submit a single byte of data to the serial port
     * transmit buffer.
     *
    ...
    /**
     * This method is called to submit a byte array of data to the serial port
     * transmit buffer.
     *
    ...
    /**
     * This method is called to submit a string of data to the serial port
     * transmit buffer.
     *
    ...
    /**
     * This method is called to submit a string of data with trailing CR + LF
     * characters to the serial port transmit buffer.
     *
     * @param data A string of data to be transmitted.
     */
    ...
    /**
     * This method is called to submit a string of formatted data to the serial
     * port transmit buffer.
     *
     * @param data A string of formatted data to be transmitted.
     * @param args A series of arguments that can be included for the format
     * string variable replacements.
     */
    ...
    /**
     * This method is called to submit a string of formatted data with trailing
     * CR + LF characters to the serial port transmit buffer.
     *
     * @param data A string of formatted data to be transmitted.
     * @param args A series of arguments that can be included for the format
     * string variable replacements.
    ...
    /**
     * This method is called to determine if and how many bytes are available on
     * the serial received data buffer.
     *
     * @return The number of available bytes pending in the serial received
     * buffer is returned.
     */
    ...
    /**
     * <p>
     * Add Serial Event Listener</p>
     *
     * <p>
     * Java consumer code can call this method to register itself as a listener
     * for serial data events. </p>
     *
     * @see #com.pi4j.io.serial.SerialDataListener
     * @see #com.pi4j.io.serial.SerialDataEvent
     *
     * @param listener A class instance that implements the SerialListener
     * interface.
     */
    ...
    /**
     * <p>
     * Remove Serial Event Listener</p>
     *
     * <p>
     * Java consumer code can call this method to unregister itself as a
     * listener for serial data events. </p>
     *
     * @see #com.pi4j.io.serial.SerialDataListener
     * @see #com.pi4j.io.serial.SerialDataEvent
     *
    ...
    /**
     * This method can be called to forcefully shutdown all serial data
     * monitoring threads.
     */
    @Override
