...
import bluej.doclet.doclets.internal.toolkit.util.PackageListWriter;
...
public abstract class AbstractDoclet {
    ...
    private static final String TOOLKIT_DOCLET_NAME = new
        bluej.doclet.doclets.formats.html.HtmlDoclet().getClass().getName();
