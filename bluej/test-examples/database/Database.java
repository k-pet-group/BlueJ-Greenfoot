...
public class Database {
	...
	public Database () {
		theVector = new PersonVector ();
	}

	public void addPerson (Person p) {
		theVector.addPerson (p);
	}
	...
	public void showAll () {
		for (Enumeration e = theVector.persons(); e.hasMoreElements() ;) {
