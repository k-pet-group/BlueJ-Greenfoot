...
Note that compilation will undergo an overhaul in BlueJ 4.0.0, and has already
...
\subsection{\lstinline!"shown_error_indicator"!}

Since BlueJ 4.0.0 (and in Greenfoot 3.0.0 onwards), error display has changed.  Errors
...
For BlueJ 4.0.0 and Greenfoot, a |"shown_error_message"| master event is generated when the user is
...
Since BlueJ 4.0.0, which shows errors as a red underline, all Java errors are marked
...
|"shown_error_message"| events above, especially for Stride.
