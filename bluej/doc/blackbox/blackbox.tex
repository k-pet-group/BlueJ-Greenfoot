...
TODO mention the spurious line-ending-adding edit

TODO what about test classes with no source?

\chapter{Data Access}

TODO talk about machine address, accounts, MySQL (SSH tunnels?), feed, etc
...
The second machine, nicknamed white, has a live-cloned database from the recording
...
processed) on to their own machine.  We ask that you act responsibly, and make
sure that the raw data is not made public, and also that you take care to not
let your account on the white machine be compromised.  If you need multiple
researchers at your institution to have access, we would prefer giving them
all accounts to encouraging the practice of sharing accounts (and thus passwords).
...
TODO talk about if they are allowed to take data, who to share it with
