...
\item |source_history_type| is |"java_gen_from_stride"| -- This is for the Java file when
  a Java to Stride conversion is performed.  This conversion results in the Java file switching from user-edited to auto-generated.
  |content| will be the diff against the previous version of this source file.
