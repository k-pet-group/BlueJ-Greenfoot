...
\item Each event (actually, session should do) should record which BlueJ version it was recorded with.
...
\item Record version control
\end{itemize}

\section{Questions}

Meeting: talk about adding sessions, then making them per-project.  Or per-package?
...
different?  Sessions should be per-project at least, but should they actually be per-package?
