...
\item Sessions aren't being tracked very easily: user only keeps last sequence id,
  but currently you need to look for a bluej_start event to group sessions
\item TODO model sessions in database!
\end{itemize}
