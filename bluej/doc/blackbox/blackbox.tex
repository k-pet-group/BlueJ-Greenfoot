...
These three events will only be recorded in versions of BlueJ from 3.2.0 onwards.
...
as shown (unless there is an unexpected problem, such as an invalid location).

Stride files report the error location in the Java file.
