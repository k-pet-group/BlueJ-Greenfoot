...
\subsection{\lstinline!"shown_error"!}
...
For these software versions, an |"shown_error"| master event is generated when the user is
...
will only get an |"shown_error"| event generated once, the first time it is shown.  If another
...
The |sub_event_type| of |"shown_error"| events will be |"CompileOutput"| and the |sub_event_id|
...
this table, but see the details on the |"shown_error"| event above.
