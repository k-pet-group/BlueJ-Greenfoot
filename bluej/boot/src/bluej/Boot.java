 ...
 * @author  Bruce Quig
 * @version $Id: Boot.java 5744 2008-05-03 13:59:07Z polle $
 */
public class Boot
{
public static final int BLUEJ_VERSION_MAJOR = 2;
    ...
    public static String GREENFOOT_VERSION = "1.4.5 beta";
    public static String GREENFOOT_API_VERSION = "1.4.5";
    ...
    private static String[] bluejJars = { "bluejcore.jar", "bluejeditor.jar", "bluejext.jar",
                                          ...
                                          "sshconnection.jar", "jsch.jar", "svnkit-javahl.jar",
                                          "svnkit.jar", "trilead.jar"};
