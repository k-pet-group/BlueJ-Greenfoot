 ...
 * @author  Bruce Quig
 * @version $Id: Boot.java 4720 2006-11-27 14:07:19Z polle $
 */
public class Boot
{
public static final int BLUEJ_VERSION_MAJOR = 2;
    ...
    public static String GREENFOOT_VERSION = "1.1.0";
    public static String GREENFOOT_API_VERSION = "1.1.0";
