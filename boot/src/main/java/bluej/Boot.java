...
public class Boot
{
    ...
    public static final String BLUEJ_VERSION = "5.2.0";
    public static final String GREENFOOT_VERSION = "3.7.1";
    ...
    private static final String[] bluejUserJars = { "bluejcore.jar", "javafx-*.jar", "junit-*.jar", "hamcrest-*.jar", "lang-stride.jar" };
